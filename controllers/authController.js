...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  const newUser = await User.create({
    ...
    role: req.body.role, // this should not be here because its make our app a hole for forbiden access!!
  });
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `if you forgot your password submit a PATC request with your new password and passwordConfirm to: ${resetURL}.\nIf you didn't forget your password, please ignore this email!`;
